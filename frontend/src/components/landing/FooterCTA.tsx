      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-y-12 gap-x-8 pb-16">
        <div className="col-span-2 lg:col-span-1">
          ...
          <div className="flex items-center gap-3">
             ...
             <a href="https://github.com/eyesee11/Slotify" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-blue-600 hover:border-blue-200 transition-colors shadow-sm">
